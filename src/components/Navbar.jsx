...
const Navbar = ({ quantity, scrollToSection }) => {
  return (
    <div>
      <div
      ...
      >
        <div className="hidden p-5" id="menu-content">
          ...
          <div className="flex flex-col gap-5">
            <div
              className="relative no-underline anchor"
      ...
      <nav className="fixed bg-violet-600 text-white font-semibold px-14 py-5 sm:px-8 lg:px-24 z-10 w-full flex justify-between items-center">
        ...
        <div className="menu-items md:flex gap-10 sm:hidden">
          <div
            className="relative no-underline active-section cursor-pointer"
            id="shop-anchor"
            onClick={() => {
              const shopAnchor = document.getElementById("shop-anchor");
              const contactAnchor = document.getElementById("contact-anchor");

              shopAnchor.classList.add("active-section");
              contactAnchor.classList.remove("active-section");
          ...
          <div
            ...
            onClick={() => {
              const shopAnchor = document.getElementById("shop-anchor");
              const contactAnchor = document.getElementById("contact-anchor");
              shopAnchor.classList.remove("active-section");
              contactAnchor.classList.add("active-section");
        ...
        >
          <div
            className="absolute top-0 right-0 w-2 h-2 rounded-md bg-red-600 hidden"
            id="notification"
          ></div>
