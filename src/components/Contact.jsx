  ...
  return (
    <div className="flex flex-col gap-10 items-center" id={id}>
      ...
      <div className="flex flex-col gap-5 items-center">
        <p>hyshoes@buysneakers.com</p>

        <p>+123 45 67 89 0</p>
      </div>
      <footer className="bg-violet-600 flex flex-col items-center rounded-md w-full h-52 gap-10 justify-center text-white p-5">
        <div className="flex gap-10" id="socials">
        ...
        <span className="font-semibold sm:text-xs md:text-base">&copy; 2024 Hyshoes. All rights reserved.</span>
      </footer>
    </div>
  );
};
